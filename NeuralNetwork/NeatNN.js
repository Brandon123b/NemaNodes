...
class NeatNN {
    ...
    */ 
    CalculatePenalty() {
        this.penalty = this.connections.length * 0.003 + this.nodes.length * 0.008;
    }
    ...
    Mutate() {
        ...
        // The amount of mutations that have been done
        this.lastDiff = {
            weight: 0,
            connection: 0,
            node: 0
